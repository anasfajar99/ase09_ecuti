                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="m-r-10"><img
                                                                src="{{ asset('images/product-pic-2.jpg') }}" alt="user"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="m-r-10"><img
                                                                src="{{ asset('images/product-pic-3.jpg') }}" alt="user"
                                                                class="rounded" width="45"></div>
                                                    </td>
                                                    <td>Faiz</td>
                                                    <td>id000003 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="m-r-10"><img
                                                                src="{{ asset('images/product-pic-4.jpg') }}" alt="user"
                                                                class="rounded" width="45"></div>
                                                    </td>
                                                    <td>Gilang </td>
                                                    <td>id000004 </td>
                                                ...
                                                <tr>
                                                    <td colspan="9"><a href="#" class="btn btn-outline-info">View
                                                            Details</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="card-body border-top">
                                            <a href="{{ '/form_ajukan_cuti' }}" class="btn btn-brand btn-block">Ajukan
                                                Cuti</a>
                                        </div>
