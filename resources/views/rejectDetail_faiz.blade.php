                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>Dashboard</a>                           
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{'/dashboard_hrd_gilang_pending'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-angle-right"></i>Pending</a>                           
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{'/dashboard_biah_approved'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class=" fas fa-angle-right"></i>Approved</a>                           
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{'/rejectDetail'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-angle-right"></i>Rejected</a>                           
                            </li>
                        </ul>
                    </div>
                </nav>
