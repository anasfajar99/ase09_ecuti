            ...
            <div class="card-body">
                <form id="form" data-parsley-validate="" novalidate="" action="{{ '/inputCuti' }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9 col-lg-9">
                            <input name="lama_cuti" id="lama_cuti" type="text" required="" data-parsley-type="url" placeholder="Lama Cuti" class="form-control" required>
                        </div>  
                    </div>
                    <div class="row pt-2 pt-sm-5 mt-1">
                        ...
                        <div class="col-sm-6 pl-0">
                            <p class="text-right">
                                <button type="submit" class="btn btn-space btn-primary">Input</button>
                                <button class="btn btn-space btn-secondary">Batalkan</button>
                            </p>
                        </div>
                    </div>
                </form>
