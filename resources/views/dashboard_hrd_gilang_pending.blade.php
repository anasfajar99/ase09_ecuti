                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            {{-- <li class="nav-item">
                                <a class="nav-link" href="#" aria-expanded="false" aria-controls="submenu-10"><i
                                        class="fas fa-fw fa-chart-pie"></i>Dashboard</a>
                                <a class="nav-link" href="#" aria-expanded="false" aria-controls="submenu-10"><i
                                        class="fas fa-calendar-alt"></i>Pengajuan</a>
                            </li> --}}
                            <li class="nav-item active">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{'/dashboard_biah_approved'}}">Approve</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{'/rejectDetail'}}">Reject</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
