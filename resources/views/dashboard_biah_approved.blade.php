                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="{{'/dashboard_hrd_gilang_pending'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-clock"></i>Pending</a>

                                <a class="nav-link" href="{{'/dashboard_biah_approved'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-calendar-check"></i>Approved</a>

                                <a class="nav-link" href="{{'/rejectDetail'}}" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-calendar-times"></i>Reject</a>
