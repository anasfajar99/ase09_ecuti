                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>30</td>
                                                        <td>Sakit</td>
                                                        <td><span class="badge-dot badge-brand mr-1"></span>Not Approved </td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>
                                           ...
                                           <div class="card-body border-top">
                                            <li><a href="{{'/form_ajukan_cuti'}}" class="btn btn-primary btn-block">Ajukan Cuti</a></li>
                                        </div>
                                        </div>
                                    </div>
                                </div>
